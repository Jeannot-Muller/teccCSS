...
#tag Events lbDemo
	#tag Event
		Sub Opening()
		  lbDemo.HeaderAt(0) = "Firstname"
		  
		  lbDemo.AddRow("Alyssa")
		  lbDemo.AddRow("Dana")
		  lbDemo.AddRow("Geoff")
		  lbDemo.AddRow("Greg")
		  lbDemo.AddRow("Jason")
		  lbDemo.AddRow("Javier")
		  lbDemo.AddRow("Paul")
		  lbDemo.AddRow("Robin")
